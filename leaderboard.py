...
class Bot(commands.Bot):
    ...
    async def Leaderboard_snap(self, sorted_chatter):
        top_three = dict(list(sorted_chatter.items())[:3])
        ...
        '''
        Ranking_message += await self.random_chatter(sorted_chatter)
...
# {'machinegun21k': 14, 'victor_vickie': 12.0, 'djwagner_gda': 7, 'grimybadger': 3, 'codingwithstrangers': 2, 'nightbot': 0}
bot = Bot()
bot.run()
